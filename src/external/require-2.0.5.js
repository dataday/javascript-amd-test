...
/**
 * @desc Configure requirejs to refer to many modules at a single URL in a DRY way.
 * @name addPaths
 * @function
 * @memberof require
 * @example
 *     require.addPaths(
 *         '//example.com/long/path/to/package/theWorks.js',
 *         ['module-1', 'another-1', 'yetanother-2'],
 *
 *         '//example.com/long/path/to/different/manymodules.js',
 *         ['first-1', 'second-1']
 *     );
 * @author Michael Mathews <michael.mathews@bbc.co.uk>
 */
